package sb.faithd1ck.utils.player;

import sb.faithd1ck.utils.math.Location;
...
public class RotationUtils {
    ...
    public static Vector2f calculate(final sb.faithd1ck.utils.vector.Vector3d from, final sb.faithd1ck.utils.vector.Vector3d to) {

        final sb.faithd1ck.utils.vector.Vector3d diff = to.subtract(from);
    ...
    public static Vector2f calculate(final Vec3 to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0, mc.thePlayer.getEyeHeight(), 0), new sb.faithd1ck.utils.vector.Vector3d(to.xCoord, to.yCoord, to.zCoord));
    }

    public static Vector2f calculate(final sb.faithd1ck.utils.vector.Vector3d to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0, mc.thePlayer.getEyeHeight(), 0), to);
    }

    public static Vector2f calculate(final sb.faithd1ck.utils.vector.Vector3d position, final EnumFacing enumFacing) {
        ...
        return calculate(new sb.faithd1ck.utils.vector.Vector3d(x, y, z));
    }
