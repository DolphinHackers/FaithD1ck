...
import static sb.faithd1ck.utils.megawalls.FkCounter.MW_GAME_START_MESSAGE;
...
public class ModuleHUD extends CheatModule {
    ...
    public void onEnable() {
        FaithD1ck.moduleManager.resetCopiedModules();
    }
    ...
    private final Handler<Render2DEvent> renderHandler = event -> {
        ...
        final List<CheatModule> modules = new ArrayList<>(FaithD1ck.moduleManager.getModules());
            ...
            if (facyfont.getValue()) {
                ...
                if (module.getState()) {
                    if (module.slide < width) {
                        ...
                        module.slideStep += FaithD1ck.delta / 4F;
                    }
        ...
        if (information.isEnabled("UserInfo")) {
            String info;
            if (FaithD1ck.IS_BETA) {
                info = GRAY + "Beta" + GRAY + " - " + WHITE + FaithD1ck.VERSION + GRAY + " - " + GRAY
                        + "NoCheatPlus";
            } else {
                info = GRAY + "Release" + GRAY + " - " + WHITE + FaithD1ck.VERSION + GRAY + " - " + GRAY
                        + "NoCheatPlus";
            }
