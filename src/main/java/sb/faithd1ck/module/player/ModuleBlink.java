...
public class ModuleBlink extends CheatModule {
    ...
    public void onEnable() {
        ...
        if (FaithD1ck.moduleManager.getModule(ModuleAntiVoid.class).getState()) {
            FaithD1ck.notificationManager.pop("You can use antivoid and blink in the same time", 5000, NotificationType.WARNING);
            toggle();
        }
