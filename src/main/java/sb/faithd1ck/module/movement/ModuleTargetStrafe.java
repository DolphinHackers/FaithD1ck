...
import sb.faithd1ck.event.impl.MoveEvent;
...
public class ModuleTargetStrafe extends CheatModule {
    ...
    private final ValueBoolean holdJump = new ValueBoolean("HoldJump", false);
...
//            if (jump) mc.thePlayer.setSprinting(false);
    ...
    private boolean canStrafe() {
        return FaithD1ck.moduleManager.getModule(ModuleKillAura.class).getState() && ModuleKillAura.target != null && !mc.thePlayer.isSneaking() && (mc.gameSettings.keyBindJump.pressed || !holdJump.getValue());
    }
