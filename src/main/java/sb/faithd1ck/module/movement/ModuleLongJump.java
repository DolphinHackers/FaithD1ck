...
import sb.faithd1ck.module.combat.ModuleVelocity;
...
public class ModuleLongJump extends CheatModule {
    ...
    public void onDisable() {
        ...
        FaithD1ck.moduleManager.getModule(ModuleVelocity.class).setState(true);
    ...
    public void onEnable() {
        if (getFireball() == -1) {
            FaithD1ck.notificationManager.pop("Could not find Fireball", "LongJump", NotificationType.INFO);
            return;
        }
        FaithD1ck.moduleManager.getModule(ModuleVelocity.class).setState(false);
        initTicks = 0;
        offGroundTicks = 0;
