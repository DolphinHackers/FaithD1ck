...
import sb.faithd1ck.hackerdetector.utils.Vector3D;
import sb.faithd1ck.hackerdetector.utils.ViolationLevelTracker;
import sb.faithd1ck.module.world.ModuleHackerDetector;
...
public abstract class Check implements ICheck {
    ...
    private void printFlagMessage(EntityPlayer player) {
        ...
        if(FaithD1ck.moduleManager.getModule(ModuleHackerDetector.class).getState()) {
            DebugUtil.log(msg);
        }
    }
