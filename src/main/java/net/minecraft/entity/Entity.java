...
import sb.faithd1ck.event.impl.SafeWalkEvent;
import sb.faithd1ck.event.impl.StrafeEvent;
import sb.faithd1ck.module.render.ModuleCamera;
import sb.faithd1ck.utils.RiseSecret;
import sb.faithd1ck.utils.player.RotationUtils;
import sb.faithd1ck.utils.vector.Vector3d;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void setAngles(float yaw, float pitch) {
        ...
        ModuleCamera module = FaithD1ck.moduleManager.getModule(ModuleCamera.class);
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            FaithD1ck.INSTANCE.getEventManager().callEvent(safeWalkEvent);
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(eventStrafe);
