...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void jump() {
        ...
        if (this instanceof EntityPlayerSP) {
            FaithD1ck.INSTANCE.getEventManager().callEvent(jumpEvent);
    ...
    public void onLivingUpdate()
    {
        ...
        if (FaithD1ck.moduleManager.getModule("NoJumpDelay") != null && Minecraft.getMinecraft().thePlayer != null) {
            if (FaithD1ck.moduleManager.getModule("NoJumpDelay").getState()) {
                this.jumpTicks = 0;
            }
        }
