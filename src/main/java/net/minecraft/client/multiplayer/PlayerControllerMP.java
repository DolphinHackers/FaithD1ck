...
import sb.faithd1ck.event.impl.ClickWindowEvent;
...
public class PlayerControllerMP
{
    ...
    {
        FaithD1ck.INSTANCE.getEventManager().callEvent(new AttackEvent(targetEntity));
        this.syncCurrentPlayItem();
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn)
    {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(clickWindowEvent);
