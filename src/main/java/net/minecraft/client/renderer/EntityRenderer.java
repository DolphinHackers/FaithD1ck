...
import sb.faithd1ck.module.combat.ModuleGhostHand;
import sb.faithd1ck.module.render.ModuleCamera;
import sb.faithd1ck.ui.notifiction.NotificationRenderer;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float targetThirdViewTranslate;
    private float thirdViewTranslate;
    private float lastThirdViewRot;
    ...
    public void removeEntities(List<Entity> list) {
        ...
        if (FaithD1ck.moduleManager.getModule(ModuleGhostHand.class).getState()) {
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
            if(FaithD1ck.moduleManager.getModule(ModuleCamera.class).getState() && FaithD1ck.moduleManager.getModule(ModuleCamera.class).getNoHurtCam())return;
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        boolean cantSmooth = Minecraft.getMinecraft() == null ||
                Minecraft.getMinecraft().gameSettings.thirdPersonView == 0 ||
                FaithD1ck.moduleManager == null ||
                Minecraft.getMinecraft().thePlayer == null ||
                FaithD1ck.moduleManager.getModule(ModuleCamera.class) == null ||
                !FaithD1ck.moduleManager.getModule(ModuleCamera.class).getState() ||
                !FaithD1ck.moduleManager.getModule(ModuleCamera.class).motionCamera.getValue();
        float smoothLevel = FaithD1ck.moduleManager.getModule(ModuleCamera.class).motionLevel.getValue();
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3) {
                            if (!FaithD1ck.moduleManager.getModule(ModuleCamera.class).getState() ||
                                    !FaithD1ck.moduleManager.getModule(ModuleCamera.class).getViewClip()) {
                                d3 = d7;
                            }
                        }
                    }
                ...
                if (this.mc.gameSettings.thirdPersonView == 2)
                {
                    GlStateManager.rotate(targetRotation, 0.0F, 1.0F, 0.0F);
                }

                targetThirdViewTranslate = (float) -d3 * (FaithD1ck.moduleManager.getModule(ModuleCamera.class).getState() ? FaithD1ck.moduleManager.getModule(ModuleCamera.class).dist.getValue() : 1f);
                if (this.mc.gameSettings.thirdPersonView == 2) {
                    targetThirdViewTranslate = -targetThirdViewTranslate;
                }
                float deltaT = targetThirdViewTranslate - thirdViewTranslate;
                if (Math.abs(deltaT) <= 0.0000125 || cantSmooth) {
                    thirdViewTranslate = targetThirdViewTranslate;
                } else {
                    thirdViewTranslate += deltaT / smoothLevel;
                }

                GlStateManager.rotate(entity.rotationPitch - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(entity.rotationYaw - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, thirdViewTranslate);
        ...
        else
        {
            ...
            targetThirdViewTranslate = 0;
            thirdViewTranslate = 0;
            lastThirdViewRot = 0;
        }
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            ...
            if (FaithD1ck.moduleManager.getModule(ModuleCamera.class).getState() && FaithD1ck.moduleManager.getModule(ModuleCamera.class).getMcLock() && Mouse.isButtonDown(2)) {
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (Minecraft.getMinecraft().getRenderManager() != null) {
            ...
            GlStateManager.translate(renderManager.deltaX, renderManager.deltaY, renderManager.deltaZ);
        }
    }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (entity != null) {
            ...
            Minecraft.getMinecraft().getRenderManager().setRenderPosition(d3, d4, d5);
        }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(new Render3DEvent(partialTicks));
