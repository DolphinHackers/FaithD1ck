...
public class RenderManager
{
    ...
    public double _renderPosX;
    public double _renderPosY;
    public double _renderPosZ;
    public double targetRenderPosX;
    public double targetRenderPosY;
    public double targetRenderPosZ;
    ...
    public void setRenderPosition(double renderPosXIn, double renderPosYIn, double renderPosZIn)
    {
        ...
        this.targetRenderPosX = renderPosXIn;
        this.targetRenderPosY = renderPosYIn;
        this.targetRenderPosZ = renderPosZIn;
        if (Minecraft.getMinecraft() == null ||
            ...
            this._renderPosX = renderPosXIn;
            this._renderPosY = renderPosYIn;
            this._renderPosZ = renderPosZIn;
            this.deltaX = 0;
            this.deltaY = 0;
            this.deltaZ = 0;
            return;
        }
        double minimizedMove = 0.0000125;
        double smoothSize = FaithD1ck.moduleManager.getModule(ModuleCamera.class).motionLevel.getValue();
        double diffX = this.targetRenderPosX - this._renderPosX;
        double diffY = this.targetRenderPosY - this._renderPosY;
        double diffZ = this.targetRenderPosZ - this._renderPosZ;
        if (Math.abs(diffX) <= minimizedMove) {
            this._renderPosX = this.targetRenderPosX;
        } else {
            this._renderPosX += diffX / smoothSize;
        }
        if (Math.abs(diffY + this.deltaY) <= minimizedMove && Math.abs(diffY - this.deltaY) <= minimizedMove && Math.abs(diffY) <= minimizedMove) {
            this._renderPosY = this.targetRenderPosY;
        } else {
            this._renderPosY += diffY / smoothSize;
        }
        if (Math.abs(diffZ) <= minimizedMove) {
            this._renderPosZ = this.targetRenderPosZ;
        } else {
            this._renderPosZ += diffZ / smoothSize;
        }

        this.deltaX = this.targetRenderPosX - this._renderPosX;
        this.deltaY = this.targetRenderPosY - this._renderPosY;
        this.deltaZ = this.targetRenderPosZ - this._renderPosZ;
    }
