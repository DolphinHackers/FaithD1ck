...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        if (FaithD1ck.moduleManager.getModule(ModuleStaffDetector.class).getState() && ModuleStaffDetector.staff.contains(networkPlayerInfoIn.getGameProfile().getName())) {
            str = EnumChatFormatting.RED + "[STAFF] " + EnumChatFormatting.RESET + str;
        }
