...
import sb.faithd1ck.ui.altmanager.GuiAltManager;
import sb.faithd1ck.ui.font.FontManager;
import sb.faithd1ck.ui.menu.AstolfoMenuButton;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GlStateManager.popMatrix();
        String s = "FaithD1ck Client #" + FaithD1ck.VERSION;
        FontManager.sf20.drawString(s, 5, this.height - 10, new Color(187, 187, 187, 255).getRGB());

        Optional<String> username = Optional.of("NoCheatPlus");
        ...
        for (AstolfoMenuButton button : this.buttons) {
        ...
        int imageX, imageY;
        int astolfo = FaithD1ck.INSTANCE.astolfo;
        switch (astolfo) {
            case 0:
                imageX = imageWidth[0];
