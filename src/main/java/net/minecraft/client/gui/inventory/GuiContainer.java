...
import sb.faithd1ck.module.player.ModuleContainerStealer;
import sb.faithd1ck.module.player.ModuleInvManager;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1002, 3, 24, 106, 21, "Disable InvManager"));
        this.buttonList.add(new GuiButton(1004, 3, 45, 106, 21, "Disable Stealer"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ModuleContainerStealer stealer = FaithD1ck.moduleManager.getModule(ModuleContainerStealer.class);
        ...
        if (mouseButton == 0) {
            for (GuiButton guibutton : this.buttonList) {
                if (guibutton.mousePressed(this.mc, mouseX, mouseY)) {
                    final ModuleManager moduleManager = FaithD1ck.moduleManager;

                    switch (guibutton.id) {
                        case 1001:
                            final ModuleKillAura killAura = moduleManager.getModule(ModuleKillAura.class);

                            if (killAura.getState()) killAura.toggle();
                            break;
                        case 1002:
                            final ModuleInvManager invManager = moduleManager.getModule(ModuleInvManager.class);

                            if (invManager.getState()) invManager.toggle();
                            break;
                        case 1004:
                            final ModuleContainerStealer chestStealer = moduleManager.getModule(ModuleContainerStealer.class);

                            if (chestStealer.getState()) chestStealer.toggle();
                            break;
                    }
                }
            }
