...
import sb.faithd1ck.utils.MouseInputHandler;
...
public class GuiChat extends GuiScreen
{
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        if (!inputField.getText().startsWith(String.valueOf(FaithD1ck.commandManager.getPrefix()))) return;
        FaithD1ck.commandManager.autoComplete(inputField.getText());
    }
    ...
    {
        if (FaithD1ck.commandManager.autoComplete(p_146405_1_)) {
            waitingOnAutocomplete = true;

            final List<String> latestAutoComplete = FaithD1ck.commandManager.getLatestAutoComplete();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        try {
            if (!FaithD1ck.commandManager.getLatestAutoComplete().isEmpty() && !inputField.getText().isEmpty() && inputField.getText().startsWith(String.valueOf(FaithD1ck.commandManager.getPrefix()))) {
                final List<String> latestAutoComplete = FaithD1ck.commandManager.getLatestAutoComplete();
    ...
    public void onAutocompleteResponse(String[] p_146406_1_)
    {
        if (this.waitingOnAutocomplete)
        {
            ...
            {
                this.playerNamesFound = true;
                if (!FaithD1ck.commandManager.getLatestAutoComplete().isEmpty()) return;
                this.autocompletePlayerNames();
            }
        }
    }
