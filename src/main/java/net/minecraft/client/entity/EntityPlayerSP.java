...
import sb.faithd1ck.module.movement.ModuleSprint;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            FaithD1ck.INSTANCE.getEventManager().callEvent(new UpdateEvent());
            super.onUpdate();
    ...
    public void onUpdateWalkingPlayer() {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(eventMotion);
    ...
    public void onLivingUpdate()
    {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(livingUpdateEvent);
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            FaithD1ck.INSTANCE.getEventManager().callEvent(event);
        ...
        if (this.isSprinting() && (this.movementInput.moveForward < f || this.isCollidedHorizontally || !flag3) && !(FaithD1ck.moduleManager.getModule(ModuleSprint.class).getState() && ModuleSprint.allDirection.getValue() && PlayerUtils.isMoving()))
        {
            this.setSprinting(false);
        }
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        FaithD1ck.INSTANCE.getEventManager().callEvent(moveEvent);
        ...
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                FaithD1ck.INSTANCE.getEventManager().callEvent(stepEvent);
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    FaithD1ck.INSTANCE.getEventManager().callEvent(new StepEvent(this.stepHeight, StepEvent.Type.POST));
                }
            }
