...
import sb.faithd1ck.module.player.ModuleFastPlace;
import sb.faithd1ck.module.world.ModuleDisabler;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException {
        ...
        final int deltaTime = (int) (currentTime - FaithD1ck.lastFrame);
        FaithD1ck.lastFrame = currentTime;
        FaithD1ck.delta = deltaTime;
    ...
    private void rightClickMouse()
    {
        if (!this.playerController.getIsHittingBlock())
        {
            ...
            if (FaithD1ck.moduleManager.getModule(ModuleFastPlace.class).getState()) {
    ...
    public void runTick() throws IOException
    {
        ...
        if (!FaithD1ck.INSTANCE.taskManager.getFutureTasks().isEmpty()) {
            FaithD1ck.INSTANCE.getTaskManager().getFutureTasks().forEach(task -> {
                if (task.delay()) {
                    task.execute();
                    FaithD1ck.INSTANCE.getTaskManager().getFutureTasks().remove(task);
                } else {
                    task.run();
                }
            });
        ...
        if (this.thePlayer != null) {
            FaithD1ck.INSTANCE.getEventManager().callEvent(new TickUpdateEvent());
            FaithD1ck.hackerDetector.onTick(0);
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        FaithD1ck.INSTANCE.getEventManager().callEvent(new KeyEvent(Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()));
                        if (k == 1)
                        {
            ...
            FaithD1ck.INSTANCE.getEventManager().callEvent(blockPlaceEvent);
        ...
        FaithD1ck.hackerDetector.onTick(1);
        FaithD1ck.INSTANCE.getEventManager().callEvent(new PostUpdateEvent());
    }
    ...
    {
        FaithD1ck.INSTANCE.getEventManager().callEvent(new WorldEvent(worldClientIn));
        ...
        if (worldClientIn != null)
        {
            ...
            FaithD1ck.INSTANCE.getEventManager().callEvent(new WorldLoadEvent());
        }
        else
        {
